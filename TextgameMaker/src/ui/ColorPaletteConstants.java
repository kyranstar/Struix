...
public final class ColorPaletteConstants {
	...
	public static final Color TOOLBAR_BACKGROUND = new Color(108, 129, 137);

	public static final Color BUTTON_POSITIVE = new Color(187, 187, 187);
	public static final Color BUTTON_POSITIVE_TEXT = Color.BLACK;
	...
	public static final Color WORLD_SELECTOR_BACKGROUND = new Color(190, 10, 85);
	public static final Color WORLD_SELECTOR_BUTTON = new Color(160, 5, 65);
	public static final Color WORLD_SELECTOR_TEXT = Color.WHITE;
	public static final Color WORLD_SELECTOR_BUTTON_CURRENT = MAP_ROOM_HOLDER;//new Color(62, 155, 121);
